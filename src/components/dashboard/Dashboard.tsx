...
export function Dashboard() {
  const { activeLoans, loanHistory, isLoading } = useLoans()
  ...
  const totalPaid = loanHistory.reduce((sum, loan) => sum + loan.totalPaid, 0)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Manage your loans and lending activities</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Badge variant="yellow">LEMX</Badge>
          </CardHeader>
          <CardContent>
